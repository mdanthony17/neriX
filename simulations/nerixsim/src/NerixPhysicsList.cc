...
NerixPhysicsList::NerixPhysicsList():G4VUserPhysicsList()
{
...
NerixPhysicsList::~NerixPhysicsList()
{
}

void
NerixPhysicsList::ConstructParticle()
{
	ConstructMyBosons();
	ConstructMyLeptons();
	ConstructMyHadrons();
...
void
NerixPhysicsList::ConstructMyBosons()
{
...
void
NerixPhysicsList::ConstructMyLeptons()
{
...
void
NerixPhysicsList::ConstructMyHadrons()
{
...
void
NerixPhysicsList::ConstructMyShortLiveds()
{
}

void
NerixPhysicsList::ConstructProcess()
{
	AddTransportation();
	ConstructEM();
	ConstructOp();
...
void
NerixPhysicsList::AddTransportation()
{
...
void
NerixPhysicsList::ConstructEM()
{
	G4EmProcessOptions emProcessOptions;
	emProcessOptions.SetFluo(true);
	emProcessOptions.SetAuger(true);
	emProcessOptions.SetPIXE(false);
	emProcessOptions.SetDeexcitationActiveRegion("LXe", true, true, true);
	emProcessOptions.SetMaxEnergy(100*GeV);
	emProcessOptions.SetDEDXBinning(200);
	emProcessOptions.SetLambdaBinning(200);
	...
	while((*theParticleIterator) ())
	{
		...
		if(particleName == "gamma")
		{
			...
			physicsListHelper->RegisterProcess(thePhotoElectricEffect, particle);

			G4ComptonScattering* theComptonScattering = new G4ComptonScattering();
			theComptonScattering->SetModel(new G4PenelopeComptonModel());
			physicsListHelper->RegisterProcess(theComptonScattering, particle);

			G4GammaConversion* theGammaConversion = new G4GammaConversion();
			theGammaConversion->SetModel(new G4PenelopeGammaConversionModel());
			physicsListHelper->RegisterProcess(theGammaConversion, particle);

			G4RayleighScattering* theRayleigh = new G4RayleighScattering();
			theRayleigh->SetModel(new G4PenelopeRayleighModel());
			physicsListHelper->RegisterProcess(theRayleigh, particle);
		}
		else if(particleName == "e-")
		{
			G4eMultipleScattering* msc = new G4eMultipleScattering();
			physicsListHelper->RegisterProcess(msc, particle);
			...
			physicsListHelper->RegisterProcess(eBrem, particle);
		}
		else if(particleName == "e+")
		{
			G4eMultipleScattering* msc = new G4eMultipleScattering();
			...
			physicsListHelper->RegisterProcess(eAnni, particle);
		}
		...
		else if(particleName == "alpha" || particleName == "deuteron" || particleName == "triton" || particleName == "He3")
		{
			//multiple scattering
			pmanager->AddProcess(new G4hMultipleScattering, -1, 1, 1);
...
void
NerixPhysicsList::ConstructGeneral()
{
...
// Cuts /////////////////////////////////////////////////////////////////////
void
NerixPhysicsList::SetCuts()
{

	if(verboseLevel > 1)
		G4cout << "NerixPhysicsList::SetCuts:";
