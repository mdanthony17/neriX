...
identifier1 = 'before KNF pump and getter switch - FT@0.200"'
identifier2 = 'after KNF pump and getter switch - FT@0.190"'
...
ha3 = Hist2D(xyNumBins, xyMin, xyMax, xyNumBins, xyMin, xyMax, name='ha3', title='XY Dist' + sRun1)
...
ha5 = Hist2D(s2WidthNumBins, s2WidthMin, s2WidthMax, dtNumBins, dtMin, dtMax, name='ha5', title='S2sLowWidth vs dt' + sRun1)
run1.Draw('S2sLowWidth[0]:dt', hist=ha5)
ha5.GetXaxis().SetTitle('S2sLowWidth[0] [10 ns]')
...
ha11.SetStats(0)
"""
ha12 = Hist(dtNumBins, dtMin, dtMax, name='ha12', title='Drift Time Spectra', drawstyle='hist')
ha12.SetColor(root.kBlue)
...
#run2.get_T1().Scan('EventId:S2sTotBottom[0]:dt:S2sPeak[0]', run2.get_cuts())
...
hb3 = Hist2D(xyNumBins, xyMin, xyMax, xyNumBins, xyMin, xyMax, name='hb3', title='XY Dist' + sRun2)
...
hb5 = Hist2D(s2WidthNumBins, s2WidthMin, s2WidthMax, dtNumBins, dtMin, dtMax, name='hb5', title='S2sLowWidth vs dt' + sRun2)
...
hb11.SetStats(0)
"""
hb12 = Hist(dtNumBins, dtMin, dtMax, name='hb12', title='Drift Time Spectra', drawstyle='hist')
hb12.SetColor(root.kRed)
...
legend7 = Legend(2, textsize=0.03)
legend7.AddEntry(ha7, label=identifier1)
legend7.AddEntry(hb7, label=identifier2)
legend7.Draw('same')
...
legend8 = Legend(2, textsize=0.03)
legend8.AddEntry(ha8, label=identifier1)
legend8.AddEntry(hb8, label=identifier2)
legend8.Draw('same')
...
legend12 = Legend(2, textsize=0.03)
legend12.AddEntry(ha12, label=identifier1)
legend12.AddEntry(hb12, label=identifier2)
legend12.Draw('same')
