...
parameter1ToExamine = 'ctS2sTotBottom[0]'# need to correct in Z
lowerBound1 = 0
upperBound1 = 80
nBins1 = 40

#parameter 2 will be on y-axis
parameter2ToExamine = 'S2sLowWidth[0]' #'S2sLowWidth[S2Order[0]]'#'S2sRightEdge[S2Order[0]] - S2sLeftEdge[S2Order[0]]'
lowerBound2 = 0
upperBound2 = 1000
nBins2 = 40
