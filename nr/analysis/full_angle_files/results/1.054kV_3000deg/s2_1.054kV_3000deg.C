...
//=========  (Wed Apr  6 11:02:14 2016) by ROOT version5.34/26
   TCanvas *c6 = new TCanvas("c6", "",2431,196,640,480);
   c6->SetHighLightColor(2);
   c6->Range(-500,-15.81406,4500,142.3266);
   c6->SetFillColor(0);
   c6->SetBorderMode(0);
   c6->SetBorderSize(2);
   ...
   hS2->SetBinContent(1,25);
   hS2->SetBinContent(2,110);
   hS2->SetBinContent(3,35);
   hS2->SetBinContent(4,19);
   hS2->SetBinContent(5,6);
   hS2->SetBinContent(6,3);
   hS2->SetBinContent(7,8);
   hS2->SetBinContent(8,3);
   hS2->SetBinContent(10,1);
   hS2->SetBinContent(11,3);
   hS2->SetBinError(1,5);
   hS2->SetBinError(2,10.48809);
   hS2->SetBinError(3,5.91608);
   hS2->SetBinError(4,4.358899);
   hS2->SetBinError(5,2.44949);
   hS2->SetBinError(6,1.732051);
   hS2->SetBinError(7,2.828427);
   hS2->SetBinError(8,1.732051);
   hS2->SetBinError(10,1);
   hS2->SetBinError(11,1.732051);
   hS2->SetEntries(213);
   hS2->SetStats(0);
   hS2->SetFillStyle(0);
