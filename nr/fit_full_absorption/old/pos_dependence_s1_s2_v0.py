...
def fit_photopeak(lFilesToLoad, radialCut, numProcessors):
	...
	currentAnalysis.multithread_draw(numProcessors, 'S1sTotBottom[0]:' + secondParameter, hist=hCES, selection=peakCut)
	...
	lLow = root.TLine()
	lLow.SetLineColor(root.kBlack)
	lLow.SetLineStyle(7)
	lLow.SetLineWidth(6)
	lLow.DrawLine(s1lb, s2lb, s1ub, s2lb)

	lHigh = root.TLine()
	lHigh.SetLineColor(root.kBlack)
	lHigh.SetLineStyle(7)
	lHigh.SetLineWidth(6)
	lHigh.DrawLine(s1lb, s2ub, s1ub, s2ub)

	lLeft = root.TLine()
	lLeft.SetLineColor(root.kBlack)
	lLeft.SetLineStyle(7)
	lLeft.SetLineWidth(6)
	lLeft.DrawLine(s1lb, s2lb, s1lb, s2ub)

	lRight = root.TLine()
	lRight.SetLineColor(root.kBlack)
	lRight.SetLineStyle(7)
	lRight.SetLineWidth(6)
	lRight.DrawLine(s1ub, s2lb, s1ub, s2ub)
	...
	hS1S2PostCut = Hist2D(dHistParameters['S1NB'], dHistParameters['S1LB'], dHistParameters['S1UB'], dHistParameters['S2NB'], dHistParameters['S2LB'], dHistParameters['S2UB'], name='hS1S2PostCut', title='S2 vs. S1')
	currentAnalysis.multithread_draw(numProcessors, 'S1sTotBottom[0]:' + secondParameter, hist=hS1S2PostCut, selection=peakCut)

	c6 = Canvas(width=1100, height=480, name='c6')
	c6.Divide(2)

	c6.cd(1)
	hS1 = hS1S2PostCut.ProjectionX('hS1')
	hS1.SetMarkerSize(0)
	...
	c6.cd(2)
	hS2 = hS1S2PostCut.ProjectionY('hS2')
	hS2.SetMarkerSize(0)
	...
	currentAnalysis.multithread_draw(numProcessors, 'R^2:S1sTotBottom[0]', hist=hRS1, selection=peakCut)
	...
	currentAnalysis.multithread_draw(numProcessors, 'R^2:S2sTotBottom[0]', hist=hRS2, selection=peakCut)
	...
	currentAnalysis.multithread_draw(numProcessors, 'Z:S1sTotBottom[0]', hist=hZS1, selection=peakCut)
	...
	currentAnalysis.multithread_draw(numProcessors, 'Z:S2sTotBottom[0]', hist=hZS2, selection=peakCut)
	...
	peak = '236'
	c1.SaveAs('/Users/Matt/Desktop/s1_s2_%s_select_151109.png' % peak)
	c2.Print('/Users/Matt/Desktop/s1_r2_%s_select_151109.png' % peak)
	c3.SaveAs('/Users/Matt/Desktop/s2_r2_%s_select_151109.png' % peak)
	c4.SaveAs('/Users/Matt/Desktop/s1_z_%s_select_151109.png' % peak)
	c5.SaveAs('/Users/Matt/Desktop/s2_z_%s_select_151109.png' % peak)
