...
setup_kernel = SourceModule(cuda_full_observables_production.cuda_full_observables_production_code, no_extern_c=True).get_function('setup_kernel')
...
class nr_band_fitter(object):
    def __init__(self, l_files, anodeVoltage, cathodeVoltage, degree_setting=-4, num_mc_events=1000000, name_notes=None, yields_free=False):
        ...
        self.l_means_s2_eff_pars = [100, 394] #[7.95634366, 0.59582331]
...
if __name__ == '__main__':
    test = nr_band_fitter('nerix_160419_1331', 4.5, 0.345, num_mc_events=int(5e4))
    ...
    for i in xrange(10):
        test.likelihood_nr_band_no_nest(py_0=1.74, py_1=6.03, py_2=8.81, py_3=7.98, py_4=9.72, py_5=11.30, py_6=11.39, py_7=12.95, qy_0=6.02, qy_1=5.43, qy_2=6.19, qy_3=5.90, qy_4=6.13, qy_5=5.65, qy_6=5.31, qy_7=6.96, intrinsic_res_s1=0.15, intrinsic_res_s2=0.21, g1_value=0.13, spe_res_rv=0., g2_value=20.89, gas_gain_rv=0.5, gas_gain_width_rv=0., pf_eff_par0=test.l_means_pf_eff_pars[0], pf_eff_par1=test.l_means_pf_eff_pars[1], s1_eff_par0=0.48, s1_eff_par1=2.04, s2_eff_par0=test.l_means_s2_eff_pars[0], s2_eff_par1=test.l_means_s2_eff_pars[1], pf_stdev_par0=test.l_means_pf_stdev_pars[0], pf_stdev_par1=test.l_means_pf_stdev_pars[1], pf_stdev_par2=test.l_means_pf_stdev_pars[2], exciton_to_ion_par0_rv=0., exciton_to_ion_par1_rv=0., exciton_to_ion_par2_rv=0., scale_par= 2.0, draw_fit=True, lowerQuantile=0.0, upperQuantile=1.0, gpu_compute=True)
