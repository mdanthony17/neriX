...
#l_filenames = ['r_nerix_160708_1521']
l_filenames = ['r_nerix_160708_1521', 'r_nerix_160709_1859', 'r_nerix_160710_1735', 'r_nerix_160712_1512', 'r_nerix_160713_1705', 'r_nerix_160714_1127', 'r_nerix_160715_1527', 'r_nerix_160716_1245', 'r_nerix_160717_1438', 'r_nerix_160722_1759', 'r_nerix_160726_1635', 'r_nerix_160728_1344', 'r_nerix_160802_1530']

s_path = './reduced_root_files/'
for i in xrange(len(l_filenames)):
	l_filenames[i] = s_path + l_filenames[i] + '.root'

current_analysis = neriX_analysis.neriX_analysis(l_filenames, -50, 0.345, 4.5)
...
current_analysis.add_cut(s_na22_height_cut) # DON'T take Na22 peak in NaI (not random)
...
neriX_analysis.save_plot(['results', 'random_coincidence'], c_s2_spectrum, 's2_rate_comparison')
neriX_analysis.save_plot(['results', 'random_coincidence'], c3, 's2_trig_efficiency_random')
neriX_analysis.save_plot(['results', 'random_coincidence'], c4, 's2_trig_time')
