...
directory_descriptor = 'band_with_lindhard_model'
...
l_plots = ['plots', directory_descriptor, '%s_kV' % s_cathode_settings]
...
num_dim = 17 + len(l_cathode_settings_in_use)*(1+4+1) + 2
# 17 + scales + recombination + exciton-to-ion ratio
...
l_free_pars = ['kappa', 'intrinsic_res_s1', 'intrinsic_res_s2'] + l_field_free_pars # 20 total
...
a_gr.set_ylim([1, 5])
a_gr.set_yscale('log')
a_gr.legend(handles=l_legend_handles, loc='best', fontsize=5)
