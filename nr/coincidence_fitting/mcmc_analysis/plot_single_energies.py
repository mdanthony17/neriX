...
for cathode_setting in l_cathode_settings:
    ...
    for degree_setting in l_degree_settings_in_use:
        ...
        d_yields[cathode_setting][degree_setting]['a_samples'] = aSampler[:, -num_steps:, :num_dim].reshape((-1, num_dim))
...
for cathode_setting in l_cathode_settings:
    ...
    ax1.plot(a_energies, d_yields[cathode_setting]['a_py_median_nest'], marker='', linestyle='--', color=d_yields[cathode_setting]['color'])
...
for cathode_setting in l_cathode_settings:
    ...
    ax2.plot(a_energies, d_yields[cathode_setting]['a_qy_median_nest'], marker='', linestyle='--', color=d_yields[cathode_setting]['color'])
