...
if len(sys.argv) != 4:
    print 'Use is python perform_full_matching.py <num walkers> <file type string> <GR Stat Only>'
    sys.exit()
...
l_free_pars = ['beta', 'kappa', 'eta', 'lambda', 'pf_stdev_s1_par0', 'pf_stdev_s1_par1', 'pf_stdev_s1_par2', 'pf_stdev_s2_par0', 'pf_stdev_s2_par1', 'pf_stdev_s2_par2'] + l_field_free_pars # 20 total
