...
class fit_nr(object):
    ...
    def suppress_likelihood(self, iterations=200, a_free_par_guesses=None):
        ...
        if self.fit_type == 's' and a_free_par_guesses == None:
            ...
            a_free_par_guesses = [13.699510523950858, 2525.9379725286308, 0.17096313007182729, 7.5049035564621915, 1.1341786124554942, 0.12515150479613077, 0.64386629641479587, 0.89166045543597372, 23.121667973208957, 8.6061017938544424, 3.161981098657598, 0.75318156760932142, 123.16002934899481, 359.84126692547562, 0.17751175461282778, 1.6301931985700662, 0.49175023484967456, 0.060021796063671362, 0.37833821837717546, 944.7362333548441, 0.20206417028274162, 0.0082492227902417718, 0.91591337098113146, 4.032906114308342, 0.3699934976266343, 2.0219981120706039, 0.21735346261371372, 1.8276163006006445, 0.13128021657584774, 1.5630106773822077, 0.19891650708213288, 1.5083273115488041, 0.0084251319912293111, 0.9106962261780216, 3.9967765584238686, 0.43008879566010505, 2.0456483459574364, 0.26660358131594264, 1.8382332263830026, 0.087837795020642581, 1.4779376651564846, 0.1969253840294895, 1.5034248812172546, 0.0088121386790923802, 0.84424187009126184, 4.1514703975279446, 0.3988891110814442, 1.9517474335188087, 0.085490939485954612, 1.699871982289517, 0.21560317609682167, 1.5614278945532947, 0.22597309236575394, 1.496005534280713]
    ...
    def fix_ll_suppression(self, suppression_factor):
        self.b_suppress_likelihood = True
        self.ll_suppression_factor = suppression_factor

        print '\n\nLL suppression factor: %f\n' % self.ll_suppression_factor
