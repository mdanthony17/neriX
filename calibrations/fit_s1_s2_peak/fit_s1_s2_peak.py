...
def fit_photopeak(lFilesToLoad, radialCut, numProcessors):
	...
	while string.lower(responseSatisfied) != 'y' or fitStatus != 3:
		...
		currentAnalysis.multithread_draw(numProcessors, 'S1sTotBottom[0]:S2sTotBottom[0]', hist=h1, selection='')
...
if __name__ == '__main__':
	if len(sys.argv) != 3:
		print 'Use is python fit_s1_s2_peak.py <ROOT file> <radial cut>'
		sys.exit()
	...
	fit_photopeak(fileToLoad, radialCut, 1)
