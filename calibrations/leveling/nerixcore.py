...
#    _current_tree.SetAlias('ctof0_ns', 'tof0_ns-(0.5208-74.8760*s1stot[0]^-0.6091)')
	...
	_current_tree.SetAlias('xp0_mm', 'S2sPos%s[0][0]' % _positions_from.capitalize())
	_current_tree.SetAlias('xp1_mm', 'S2sPos%s[1][0]' % _positions_from.capitalize())
	_current_tree.SetAlias('xp2_mm', 'S2sPos%s[2][0]' % _positions_from.capitalize())
	_current_tree.SetAlias('xp3_mm', 'S2sPos%s[3][0]' % _positions_from.capitalize())

	_current_tree.SetAlias('yp0_mm', 'S2sPos%s[0][1]' % _positions_from.capitalize())
	_current_tree.SetAlias('yp1_mm', 'S2sPos%s[1][1]' % _positions_from.capitalize())
	_current_tree.SetAlias('yp2_mm', 'S2sPos%s[2][1]' % _positions_from.capitalize())
	_current_tree.SetAlias('yp3_mm', 'S2sPos%s[3][1]' % _positions_from.capitalize())
