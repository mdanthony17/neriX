...
def fit_position_corrections(lFiles, batch_mode=False, fit_full_run=False, use_mcmc=False):
	...
	for iteration_num, file in enumerate(lFiles):
		...
		d_fits[cathode_setting]['s1_z_intercept'] = d_cathode_data[cathode_setting]['s1_z_intercept']
...
if __name__ == '__main__':
	...
	if len(sys.argv) == 1:
		...
		s_for_file += fit_position_corrections(lFiles, batch_mode, use_mcmc=False)
		...
		fit_position_corrections(lFiles, fit_full_run=False, use_mcmc=False)
