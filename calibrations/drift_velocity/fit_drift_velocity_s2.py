...
def fit_drift_velocity(filename, batch_mode=False):
	...
	neriX_analysis.save_plot(['results', 'run_%d' % current_analysis.get_run(), current_analysis.get_filename_no_ext()], c1, 'drift_velocity_%s' % current_analysis.get_filename_no_ext(), batch_mode=batch_mode)
