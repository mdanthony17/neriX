...
parameter_values_list = []
res = libcaenhv.get_channel_parameter(handle=handle, slot=0, parameter_name='I0Set', nb_channels=6, channels_list=[1,2,3,4,5,6], parameter_values_list=parameter_values_list)

print 'Current Current Settings: '
print parameter_values_list
...
if setting == 'V0Set' and (settingValue > 800 or settingValue < 400):
	print 'Voltage you would like to set is either too high or low - please restart program and pick an acceptable value for the voltage (between 600 V and 800 V)'
	exit(1)
