...
#checking actual voltages of PMTs 1-5
parameter_values_list = []
...
#example of turning on PMT 1
parameter_values_list = [1]
res = libcaenhv.set_channel_parameter(handle=handle, slot=0, parameter_name='Pw', nb_channels=1, channels_list=[1], parameter_values_list=parameter_values_list)
