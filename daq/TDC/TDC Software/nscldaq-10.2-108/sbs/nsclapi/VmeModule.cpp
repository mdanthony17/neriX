...
/*
  \fn uint8_t CVmeModule::peekb(UInt_t offset=0)
...
/*
  \fn uint16_t CVmeModule::peekw(UInt_t offset=0)
...
/*
  \fn uint32_t CVmeModule::peekl(UInt_t offset=0)
...
/*
  \fn void CVmeModule::pokeb(uint8_t byte, UInt_t nOffset)
...
*/
void
CVmeModule::pokeb(uint8_t byte, UInt_t nOffset)
{
...
/*
  \fn void CVmeModule::pokew(uint16_t word, UInt_t nOffset)
...
*/
void
CVmeModule::pokew(uint16_t word, UInt_t nOffset)
{
...
/*
  \fn void CVmeModule::pokel(uint8_t lword, UInt_t nOffset)
...
*/
void
CVmeModule::pokel(uint32_t lword, UInt_t nOffset)
{
