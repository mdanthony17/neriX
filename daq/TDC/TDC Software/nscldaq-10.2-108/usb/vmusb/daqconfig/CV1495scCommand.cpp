...
*/
int
CV1495scCommand::operator()(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
...
*/
int
CV1495scCommand::config(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
...
*/
int
CV1495scCommand::cget(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
  if (objv.size() != 3) {
...
void
CV1495scCommand::Usage(std::string msg, std::vector<CTCLObject>& objv)
{
  string result("ERROR: ");
  result += msg;
  result += "\n";
