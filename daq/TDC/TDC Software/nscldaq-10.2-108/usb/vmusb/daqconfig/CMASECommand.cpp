...
*/
CMASECommand::CMASECommand(CTCLInterpreter& interp,
...
int
CMASECommand::operator()(CTCLInterpreter& interp,
...
*/
int
CMASECommand::create(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
...
*/
int
CMASECommand::config(CTCLInterpreter& interp,
		     vector<CTCLObject>& objv)
{
  if (objv.size() < 4) {
...
*/
int
CMASECommand::cget(CTCLInterpreter& interp,
		   vector<CTCLObject>& objv)
{
  if (objv.size() != 3) {
...
*/
void
CMASECommand::Usage(string msg, std::vector<CTCLObject>& objv)
{
  string result("ERROR: ");
  result += msg;
  result += "\n";
...
*/
int
CMASECommand::configure(CTCLInterpreter& interp,
