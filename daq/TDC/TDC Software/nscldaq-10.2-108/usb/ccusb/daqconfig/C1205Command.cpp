...
*/
C1205Command::C1205Command(CTCLInterpreter& interp,
...
*/
int
C1205Command::operator()(CTCLInterpreter& interp,
...
*/
int
C1205Command::create(CTCLInterpreter& interp,
		       std::vector<CTCLObject>& objv)
{
...
*/
int
C1205Command::config(CTCLInterpreter& interp,
		      std::vector<CTCLObject>& objv)
{
...
*/
int
C1205Command::cget(CTCLInterpreter& interp,
		    std::vector<CTCLObject>& objv)
{
  if (objv.size() != 3) {
...
*/
int
C1205Command::configure(CTCLInterpreter&         interp,
...
*/
string
C1205Command::configMessage(std::string base,
			    std::string key,
			    std::string value,
