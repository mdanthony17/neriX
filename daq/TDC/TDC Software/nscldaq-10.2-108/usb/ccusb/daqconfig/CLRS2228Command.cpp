...
//   Implementation of the CLRS2228Command class.
...
*/
CLRS2228Command::CLRS2228Command(CTCLInterpreter& interp,
...
*/
CLRS2228Command::~CLRS2228Command()
{
}
...
*/
int
CLRS2228Command::operator()(CTCLInterpreter& interp,
...
*/
int
CLRS2228Command::create(CTCLInterpreter& interp,
		       std::vector<CTCLObject>& objv)
{
...
*/
int
CLRS2228Command::config(CTCLInterpreter& interp,
		      std::vector<CTCLObject>& objv)
{
  ...
  CReadoutModule* pModule  = m_Config.findAdc(name);
  if(!pModule) {
    Usage("lrs2228 module does not exist", objv);
    return TCL_ERROR;
  }
  // and configure:
...
*/
int
CLRS2228Command::cget(CTCLInterpreter& interp,
		    std::vector<CTCLObject>& objv)
{
  if (objv.size() != 3) {
...
*/
CConfiguration*
CLRS2228Command::getConfiguration()
{
  return &m_Config;
}
...
*/
void
CLRS2228Command::Usage(std::string msg, std::vector<CTCLObject> objv)
{
  string result("ERROR: ");
  result += msg;
  result += "\n";
  ...
  result += "\n";
  result += "Usage\n";
  result += "    lrs2228 create name base-address\n";
  result += "    lrs2228 config name config-params...\n";
  result += "    lrs2228 cget name";
...
*/
int
CLRS2228Command:: configure(CTCLInterpreter&         interp,
...
*/
string
CLRS2228Command::configMessage(std::string base,
			    std::string key,
			    std::string value,
