...
*/
#ifndef __CLRS2249COMMAND_H
#define __CLRS2249COMMAND_H
...
/*!
   This class provides a command that creates the CLRS2249 class.  See
   ../devices/CLRS2249.h for information about the configuration options
...
\verbatim
   ...
   lrs2249 create name -slot n
   lrs2249 config name option-value-pairs
   lrs2249 cget   name
\endverbatim
...
*/
class CLRS2249Command : public CTCLObjectProcessor
{
private:
  ...
  // Allowed canonicals
public:
  CLRS2249Command(CTCLInterpreter& interp,
		CConfiguration& config,
		std::string     commandName = std::string("lrs2249"));
  virtual ~CLRS2249Command();

  // Forbidden canonicals:
private:
  CLRS2249Command(const CLRS2249Command& rhs);
  CLRS2249Command& operator=(const CLRS2249Command& rhs);
  int operator==(const CLRS2249Command& rhs) const;
  int operator!=(const CLRS2249Command& rhs) const;
public:
