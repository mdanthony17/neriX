...
//   Implementation of the CLRS2551Command class.
...
*/
CLRS2551Command::CLRS2551Command(CTCLInterpreter& interp,
...
*/
CLRS2551Command::~CLRS2551Command()
{
}
...
*/
int
CLRS2551Command::operator()(CTCLInterpreter& interp,
...
*/
int
CLRS2551Command::create(CTCLInterpreter& interp,
		       std::vector<CTCLObject>& objv)
{
...
*/
int
CLRS2551Command::config(CTCLInterpreter& interp,
		      std::vector<CTCLObject>& objv)
{
  ...
  CReadoutModule* pModule  = m_Config.findAdc(name);
  if(!pModule) {
    Usage("lrs2551 module does not exist", objv);
    return TCL_ERROR;
  }
  // and configure:
...
*/
int
CLRS2551Command::cget(CTCLInterpreter& interp,
		    std::vector<CTCLObject>& objv)
{
  if (objv.size() != 3) {
...
*/
CConfiguration*
CLRS2551Command::getConfiguration()
{
  return &m_Config;
}
...
*/
void
CLRS2551Command::Usage(std::string msg, std::vector<CTCLObject> objv)
{
  string result("ERROR: ");
  result += msg;
  result += "\n";
  ...
  result += "\n";
  result += "Usage\n";
  result += "    lrs2551 create name base-address\n";
  result += "    lrs2551 config name config-params...\n";
  result += "    lrs2551 cget name";
...
*/
int
CLRS2551Command:: configure(CTCLInterpreter&         interp,
...
*/
string
CLRS2551Command::configMessage(std::string base,
			    std::string key,
			    std::string value,
