...
const char *gengetopt_args_info_purpose = "Unpack event fragments from events";

const char *gengetopt_args_info_usage = "Usage: unglom [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --id=INT   Source id to give non event fragments",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->id_help = gengetopt_args_info_help[2] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* Source id to give non event fragments.  */
