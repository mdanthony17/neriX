...
#define dataBS2On 0x4C90 // acquistion on (check validity of data and only write to buffer if valid)
//#define dataBS2On 0x5CB0 // acquistion on (keep all channels regardless of validity of data)
#define dataBS2Off 0x4C92 // acquisition off
...
#define dataCR1 0x60 // enable BERR and enable Align 64 feature
