...
EventData::allocate()
{
	...
	m_pSingleIntegral = new std::vector<float>();
	m_pSinglePrePeakBaselineAvg = new std::vector<float>();
	m_pSinglePostPeakBaselineAvg = new std::vector<float>();
	m_pSinglePrePeakBaselineRMS = new std::vector<float>();
	m_pSinglePostPeakBaselineRMS = new std::vector<float>();
...
EventData::deallocate()
{
	...
	delete m_pSingleIntegral;
	delete m_pSinglePrePeakBaselineAvg;
	delete m_pSinglePostPeakBaselineAvg;
	delete m_pSinglePrePeakBaselineRMS;
	delete m_pSinglePostPeakBaselineRMS;
...
EventData::clear()
{
	...
	m_pSingleIntegral->clear();
	m_pSinglePrePeakBaselineAvg->clear();
	m_pSinglePostPeakBaselineAvg->clear();
	m_pSinglePrePeakBaselineRMS->clear();
	m_pSinglePostPeakBaselineRMS->clear();
