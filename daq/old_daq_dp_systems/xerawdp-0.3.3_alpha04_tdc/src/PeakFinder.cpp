...
PeakFinder::findLiqSciPeak(Waveform const *pWaveform, int iRightMax)
{
	...
	m_hLiqSciPeak = Peak(iMaxPos, iLeftExtent-2, iRightExtent+2, fLiqSciWidth, fLiqSciLowWidth, fLiqSci);
}
...
PeakFinder::findNaiPeak(Waveform const *pWaveform, int iRightMax)
{
	...
	m_hNaiPeak = Peak(iMaxPos, iLeftExtent-2, iRightExtent+2, fNaiWidth, fNaiLowWidth, fNai);
}
