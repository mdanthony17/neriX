...
public:
	...
	std::vector<std::vector<float> > const *getS1sRawNoiseMedian() const { return m_pS1sRawNoiseMedian; }
	std::vector<std::vector<float> > const *getS1sRawNoiseTrapezoid() const { return m_pS1sRawNoiseTrapezoid; }
	...
	std::vector<std::vector<float> > const *getS1sNoiseMedian() const { return m_pS1sNoiseMedian; }
	std::vector<std::vector<float> > const *getS1sNoiseTrapezoid() const { return m_pS1sNoiseTrapezoid; }
...
private:
	...
	std::vector<float> *m_pSingleIntegral;
	std::vector<float> *m_pSinglePrePeakBaselineAvg;
	std::vector<float> *m_pSinglePostPeakBaselineAvg;
	std::vector<float> *m_pSinglePrePeakBaselineRMS;
	std::vector<float> *m_pSinglePostPeakBaselineRMS;
	...
	std::vector<std::vector<float> > *m_pS1sRawNoiseMedian;
	std::vector<std::vector<float> > *m_pS1sRawNoiseTrapezoid;
	...
	std::vector<std::vector<float> > *m_pS1sNoiseMedian;
	std::vector<std::vector<float> > *m_pS1sNoiseTrapezoid;
